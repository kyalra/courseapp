    ...
    <x-slot name="header">
        ...
        <div class="py-12">
            <div class="relative overflow-x-auto max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <form action="{{ route('instructor.store') }}" method="POST" novalidate>
                    {{ csrf_field() }}
                    ...
                    <div class="mb-6">
                        <div>
                            <label for="exp_year"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Exp Year</label>
                            <input type="number" id="exp_year" name="exp_year"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Exp Year" required>
                        </div>
                    </div>
                    <div class="mb-6">
                        <label for="exp_desc" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Exp
                            Deskripsi</label>
                        <textarea id="exp_desc" name="exp_desc" rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Exp Deskripsi ......."></textarea>
